...
require (
	...
	github.com/ignite/modules v0.0.0-20230414024115-2492a02fd25e
...
replace (
	...
	github.com/tendermint/fundraising => github.com/Pantani/fundraising v0.0.0-20230417025432-5bd6743bac17
)
