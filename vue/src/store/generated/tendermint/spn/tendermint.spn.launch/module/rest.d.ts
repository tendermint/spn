...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
    queryGenesisAccount: (chainID: string, address: string, params?: RequestParams) => Promise<HttpResponse<LaunchQueryGetGenesisAccountResponse, RpcStatus>>;
}
export {};
