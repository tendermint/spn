...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  queryChain = (chainID: string, params: RequestParams = {}) =>
    this.request<LaunchQueryGetChainResponse, RpcStatus>({
      path: `/tendermint/spn/launch/chain/${chainID}`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryChainNameCountAll = (
    ...
    this.request<LaunchQueryAllChainNameCountResponse, RpcStatus>({
   ...
   */
  queryChainNameCount = (chainName: string, params: RequestParams = {}) =>
    this.request<LaunchQueryGetChainNameCountResponse, RpcStatus>({
  ...
  queryGenesisAccountAll = (
    ...
    this.request<LaunchQueryAllGenesisAccountResponse, RpcStatus>({
      path: `/tendermint/spn/launch/genesisAccount`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/tendermint/spn/launch/genesisAccount/{chainID}/{address}
   */
  queryGenesisAccount = (chainID: string, address: string, params: RequestParams = {}) =>
    this.request<LaunchQueryGetGenesisAccountResponse, RpcStatus>({
      path: `/tendermint/spn/launch/genesisAccount/${chainID}/${address}`,
      method: "GET",
      format: "json",
      ...params,
    });
