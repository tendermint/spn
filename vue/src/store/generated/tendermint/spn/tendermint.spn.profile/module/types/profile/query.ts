...
const baseQueryGetConsensusKeyNonceRequest: object = { consAddress: '' }

export const QueryGetConsensusKeyNonceRequest = {
  encode(message: QueryGetConsensusKeyNonceRequest, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetConsensusKeyNonceRequest {
    ...
    const message = { ...baseQueryGetConsensusKeyNonceRequest } as QueryGetConsensusKeyNonceRequest
...
const baseQueryGetConsensusKeyNonceResponse: object = {}

export const QueryGetConsensusKeyNonceResponse = {
  encode(message: QueryGetConsensusKeyNonceResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetConsensusKeyNonceResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryGetConsensusKeyNonceResponse } as QueryGetConsensusKeyNonceResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
const baseQueryGetValidatorByConsAddressRequest: object = { consAddress: '' }

export const QueryGetValidatorByConsAddressRequest = {
  encode(message: QueryGetValidatorByConsAddressRequest, writer: Writer = Writer.create()): Writer {
    if (message.consAddress !== '') {
      writer.uint32(10).string(message.consAddress)
    }
    return writer
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetValidatorByConsAddressRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryGetValidatorByConsAddressRequest } as QueryGetValidatorByConsAddressRequest
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
const baseQueryGetValidatorByConsAddressResponse: object = {}

export const QueryGetValidatorByConsAddressResponse = {
  encode(message: QueryGetValidatorByConsAddressResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetValidatorByConsAddressResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryGetValidatorByConsAddressResponse } as QueryGetValidatorByConsAddressResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
const baseQueryGetValidatorByAddressRequest: object = { address: '' }

export const QueryGetValidatorByAddressRequest = {
  encode(message: QueryGetValidatorByAddressRequest, writer: Writer = Writer.create()): Writer {
    if (message.address !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetValidatorByAddressRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryGetValidatorByAddressRequest } as QueryGetValidatorByAddressRequest
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
const baseQueryGetValidatorByAddressResponse: object = {}

export const QueryGetValidatorByAddressResponse = {
  encode(message: QueryGetValidatorByAddressResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetValidatorByAddressResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryGetValidatorByAddressResponse } as QueryGetValidatorByAddressResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
