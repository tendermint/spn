...
export declare type ProfileMsgDeleteCoordinatorResponse = object;
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     * @request GET:/tendermint/spn/profile/coordinator/{id}
     */
    queryCoordinator: (id: string, params?: RequestParams) => Promise<HttpResponse<ProfileQueryGetCoordinatorResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
