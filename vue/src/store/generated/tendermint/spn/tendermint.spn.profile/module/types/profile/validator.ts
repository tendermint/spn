...
const baseValidatorByAddress: object = { address: '', consensusAddress: '' }

export const ValidatorByAddress = {
  encode(message: ValidatorByAddress, writer: Writer = Writer.create()): Writer {
    if (message.address !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): ValidatorByAddress {
    ...
    const message = { ...baseValidatorByAddress } as ValidatorByAddress
...
const baseValidatorDescription: object = { identity: '', moniker: '', website: '', securityContact: '', details: '' }

export const ValidatorDescription = {
  encode(message: ValidatorDescription, writer: Writer = Writer.create()): Writer {
    if (message.identity !== '') {
...
const baseValidatorByConsAddress: object = { consAddress: '', address: '' }

export const ValidatorByConsAddress = {
  encode(message: ValidatorByConsAddress, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): ValidatorByConsAddress {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseValidatorByConsAddress } as ValidatorByConsAddress
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
const baseConsensusKeyNonce: object = { consAddress: '', nonce: 0 }

export const ConsensusKeyNonce = {
  encode(message: ConsensusKeyNonce, writer: Writer = Writer.create()): Writer {
    if (message.consAddress !== '') {
      writer.uint32(10).string(message.consAddress)
    }
    if (message.nonce !== 0) {
  ...
  decode(input: Reader | Uint8Array, length?: number): ConsensusKeyNonce {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseConsensusKeyNonce } as ConsensusKeyNonce
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
