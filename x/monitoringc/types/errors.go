...
var (
	...
	ErrClientNotVerified            = sdkerrors.Register(ModuleName, 10, "ibc client not verified")
	ErrConnectionAlreadyEstablished = sdkerrors.Register(ModuleName, 11, "ibc connection already established")
)
