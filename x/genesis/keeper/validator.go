...
func (k Keeper) SetValidator(ctx sdk.Context, chainID string, address sdk.ValAddress) {
...
func (k Keeper) IsValidatorSet(ctx sdk.Context, chainID string, address sdk.ValAddress) bool {
	store := ctx.KVStore(k.storeKey)
