...
func TestMsgRequestAddVestingAccount(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			msg:  sample.MsgRequestAddVestingAccount(addr1, chains[0].LaunchID),
			err:  types.ErrTriggeredLaunch,
		},
		{
			name: "coordinator not found",
			msg:  sample.MsgRequestAddVestingAccount(addr1, chains[1].LaunchID),
			err:  types.ErrChainInactive,
		},
		{
			name:   "add chain 3 request 1",
			msg:    sample.MsgRequestAddVestingAccount(addr1, chains[2].LaunchID),
			wantID: 0,
		},
		{
			name:   "add chain 4 request 1",
			msg:    sample.MsgRequestAddVestingAccount(addr1, chains[3].LaunchID),
			wantID: 0,
		},
		{
			name:   "add chain 4 request 2",
			msg:    sample.MsgRequestAddVestingAccount(addr2, chains[3].LaunchID),
			wantID: 1,
		},
		{
			name:   "add chain 5 request 1",
			msg:    sample.MsgRequestAddVestingAccount(addr1, chains[4].LaunchID),
			wantID: 0,
		},
		{
			name:   "add chain 5 request 2",
			msg:    sample.MsgRequestAddVestingAccount(addr2, chains[4].LaunchID),
			wantID: 1,
		},
		{
			name:   "add chain 5 request 3",
			msg:    sample.MsgRequestAddVestingAccount(addr3, chains[4].LaunchID),
			wantID: 2,
		},
		{
			name:        "request from coordinator is pre-approved",
			msg:         sample.MsgRequestAddVestingAccount(coordAddr, chains[4].LaunchID),
			wantApprove: true,
		},
		{
		...
		},
		{
			...
			msg:  sample.MsgRequestAddVestingAccount(coordAddr, chains[5].LaunchID),
