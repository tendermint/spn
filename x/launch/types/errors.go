...
var (
	...
	ErrChainHasProject             = sdkerrors.Register(ModuleName, 26, "chain already is associated with a project")
	ErrAddChainToProject           = sdkerrors.Register(ModuleName, 27, "unable to add chain to project")
