...
type Chain struct {
	...
	//	*Chain_GenesisURL
	InitialGenesis isChain_InitialGenesis `protobuf_oneof:"initialGenesis"`
}
...
type isChain_InitialGenesis interface {
	isChain_InitialGenesis()
	MarshalTo([]byte) (int, error)
	Size() int
}

type Chain_GenesisURL struct {
	GenesisURL *GenesisURL `protobuf:"bytes,8,opt,name=genesisURL,proto3,oneof" json:"genesisURL,omitempty"`
}

func (*Chain_GenesisURL) isChain_InitialGenesis() {}

func (m *Chain) GetInitialGenesis() isChain_InitialGenesis {
	if m != nil {
...
func (m *Chain) GetGenesisURL() *GenesisURL {
	if x, ok := m.GetInitialGenesis().(*Chain_GenesisURL); ok {
		return x.GenesisURL
	}
	return nil
}
...
func (*Chain) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*Chain_GenesisURL)(nil),
	}
}
...
var fileDescriptor_b71a209f7c748440 = []byte{
	...
	,
}
...
func (m *Chain_GenesisURL) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Chain_GenesisURL) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.GenesisURL != nil {
		{
...
func (m *Chain_GenesisURL) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Chain) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			m.InitialGenesis = &Chain_GenesisURL{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
