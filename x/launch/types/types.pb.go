...
type InitialGenesisType int32

const (
	InitialGenesisType_DEFAULT InitialGenesisType = 0
	InitialGenesisType_URL     InitialGenesisType = 1
)

var InitialGenesisType_name = map[int32]string{
	0: "DEFAULT",
	1: "URL",
}

var InitialGenesisType_value = map[string]int32{
	"DEFAULT": 0,
	"URL":     1,
}

func (x InitialGenesisType) String() string {
	return proto.EnumName(InitialGenesisType_name, int32(x))
}

func (InitialGenesisType) EnumDescriptor() ([]byte, []int) {
...
type Chain struct {
	...
	InitialGenesis *InitialGenesis `protobuf:"bytes,8,opt,name=initialGenesis,proto3" json:"initialGenesis,omitempty"`
}
...
type InitialGenesis_DefaultGenesis struct {
	DefaultGenesis *DefaultInitialGenesis `protobuf:"bytes,1,opt,name=defaultGenesis,proto3,oneof" json:"defaultGenesis,omitempty"`
}
...
func (*InitialGenesis_DefaultGenesis) isInitialGenesis_Source() {}
...
func (m *InitialGenesis) GetDefaultGenesis() *DefaultInitialGenesis {
	if x, ok := m.GetSource().(*InitialGenesis_DefaultGenesis); ok {
		return x.DefaultGenesis
	}
	return nil
}
...
func (*InitialGenesis) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*InitialGenesis_DefaultGenesis)(nil),
...
func (*ProposalChangePayload) Descriptor() ([]byte, []int) {
	return fileDescriptor_b71a209f7c748440, []int{9}
}
...
func (*ProposalAddAccountPayload) Descriptor() ([]byte, []int) {
	return fileDescriptor_b71a209f7c748440, []int{10}
}
...
func (m *ProposalAddAccountPayload) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (*ProposalAddValidatorPayload) Descriptor() ([]byte, []int) {
	return fileDescriptor_b71a209f7c748440, []int{11}
}
...
func (m *ProposalAddValidatorPayload) GetValidatorAddress() string {
	if m != nil {
...
func init() {
	proto.RegisterEnum("spn.launch.v1beta1.InitialGenesisType", InitialGenesisType_name, InitialGenesisType_value)
	...
	proto.RegisterType((*InitialGenesis)(nil), "spn.launch.v1beta1.InitialGenesis")
	proto.RegisterType((*DefaultInitialGenesis)(nil), "spn.launch.v1beta1.DefaultInitialGenesis")
	proto.RegisterType((*GenesisURL)(nil), "spn.launch.v1beta1.GenesisURL")
...
var fileDescriptor_b71a209f7c748440 = []byte{
	...
	,
}
...
func (m *InitialGenesis_DefaultGenesis) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *InitialGenesis_DefaultGenesis) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DefaultGenesis != nil {
		{
			size, err := m.DefaultGenesis.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ProposalList) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ProposalIDs) > 0 {
		dAtA10 := make([]byte, len(m.ProposalIDs)*10)
		var j9 int
...
func (m *InitialGenesis_DefaultGenesis) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *InitialGenesis) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DefaultGenesis", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Source = &InitialGenesis_DefaultGenesis{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
