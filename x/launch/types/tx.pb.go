...
type MsgCreateChain struct {
	...
	DefaultAccountBalance github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,9,rep,name=defaultAccountBalance,proto3,casttype=github.com/cosmos/cosmos-sdk/types.Coin,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"defaultAccountBalance"`
...
func (m *MsgCreateChain) GetDefaultAccountBalance() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.DefaultAccountBalance
	}
	return nil
}
...
type MsgEditChain struct {
	...
	DefaultAccountBalance github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,5,rep,name=defaultAccountBalance,proto3,casttype=github.com/cosmos/cosmos-sdk/types.Coin,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"defaultAccountBalance"`
...
func (m *MsgEditChain) GetDefaultAccountBalance() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.DefaultAccountBalance
	}
	return nil
...
var fileDescriptor_6adab5ffa522f022 = []byte{
	...
	,
}
...
func (m *MsgCreateChain) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DefaultAccountBalance) > 0 {
		for iNdEx := len(m.DefaultAccountBalance) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.DefaultAccountBalance[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *MsgCreateChain) Size() (n int) {
	...
	if len(m.DefaultAccountBalance) > 0 {
		for _, e := range m.DefaultAccountBalance {
			l = e.Size()
			n += 1 + l + sovTx(uint64(l))
		}
	}
...
func (m *MsgCreateChain) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DefaultAccountBalance", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DefaultAccountBalance = append(m.DefaultAccountBalance, github_com_cosmos_cosmos_sdk_types.Coin{})
			if err := m.DefaultAccountBalance[len(m.DefaultAccountBalance)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 10:
