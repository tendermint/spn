...
type QueryMaximumSharesResponse struct {
	MaximumShares string `protobuf:"bytes,1,opt,name=maximumShares,proto3" json:"maximumShares,omitempty"`
}
...
func (m *QueryMaximumSharesResponse) GetMaximumShares() string {
	if m != nil {
...
var fileDescriptor_7a55190e2afa5f29 = []byte{
	...
	,
}
...
func (m *QueryMaximumSharesResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.MaximumShares) > 0 {
		i -= len(m.MaximumShares)
		copy(dAtA[i:], m.MaximumShares)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.MaximumShares)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *QueryMaximumSharesResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.MaximumShares = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
