...
type ClaimRecord struct {
	...
	CompletedMissions string `protobuf:"bytes,3,opt,name=completedMissions,proto3" json:"completedMissions,omitempty"`
}
...
func (m *ClaimRecord) GetClaimable() string {
	if m != nil {
		return m.Claimable
	}
	return ""
...
func (m *ClaimRecord) GetCompletedMissions() string {
	if m != nil {
...
var fileDescriptor_10f43048b7ec7af3 = []byte{
	...
	0x79, 0x7a, 0x60, 0x25, 0x4a, 0xc5, 0x5c, 0xdc, 0xce, 0x20, 0x46, 0x10, 0x58, 0xa9, 0x90, 0x04,
	0x17, 0x7b, 0x62, 0x4a, 0x4a, 0x51, 0x6a, 0x71, 0xb1, 0x04, 0xa3, 0x02, 0xa3, 0x06, 0x67, 0x10,
	0x8c, 0x2b, 0x24, 0xc3, 0xc5, 0x09, 0xd6, 0x91, 0x98, 0x94, 0x93, 0x2a, 0xc1, 0x04, 0x96, 0x43,
	0x08, 0x08, 0xe9, 0x70, 0x09, 0x26, 0xe7, 0xe7, 0x16, 0xe4, 0xa4, 0x96, 0xa4, 0xa6, 0xf8, 0x66,
	0x16, 0x17, 0x67, 0xe6, 0xe7, 0x15, 0x4b, 0x30, 0x83, 0x55, 0x61, 0x4a, 0x38, 0x39, 0x9e, 0x78,
	...
	0x5e, 0x72, 0x7e, 0xae, 0x3e, 0xc2, 0xbd, 0xfa, 0xc5, 0x05, 0x79, 0xfa, 0x15, 0x10, 0x4f, 0xe9,
	0x97, 0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0x3d, 0x65, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff,
	0x9c, 0xa5, 0xa8, 0xa2, 0xf0, 0x00, 0x00, 0x00,
}
...
func (m *ClaimRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CompletedMissions) > 0 {
		i -= len(m.CompletedMissions)
		copy(dAtA[i:], m.CompletedMissions)
		i = encodeVarintClaimRecord(dAtA, i, uint64(len(m.CompletedMissions)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Claimable) > 0 {
		...
		i = encodeVarintClaimRecord(dAtA, i, uint64(len(m.Claimable)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Address) > 0 {
...
func (m *ClaimRecord) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.CompletedMissions = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
